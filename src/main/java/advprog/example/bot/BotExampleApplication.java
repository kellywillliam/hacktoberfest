...
public class BotExampleApplication {
    ...
    public static void main(String[] args) {
        System.setProperty("line.bot.channelSecret", System.getenv("LINE_BOT_CHANNEL_SECRET"));
        System.setProperty("line.bot.channelToken", System.getenv("LINE_BOT_CHANNEL_TOKEN"));
